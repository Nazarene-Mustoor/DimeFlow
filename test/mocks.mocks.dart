...
// in expense_tracker_app/test/mocks.dart.
...
import 'package:expense_tracker_app/models/expense_model.dart' as _i8;
import 'package:expense_tracker_app/models/getaway_expense_model.dart' as _i15;
import 'package:expense_tracker_app/models/getaway_model.dart' as _i13;
import 'package:expense_tracker_app/providers/currency_provider.dart' as _i11;
import 'package:expense_tracker_app/providers/expense_provider.dart' as _i7;
import 'package:expense_tracker_app/providers/getaway_expense_provider.dart'
    as _i14;
import 'package:expense_tracker_app/providers/getaway_provider.dart' as _i12;
...
class MockFirebaseAuth extends _i1.Mock implements _i3.FirebaseAuth {
  ...
  _i6.Future<_i2.ActionCodeInfo> checkActionCode(String? code) =>
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i2.ActionCodeInfo>.value(_FakeActionCodeInfo_7(
          this,
          Invocation.method(
            #checkActionCode,
            [code],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockExpenseProvider extends _i1.Mock implements _i7.ExpenseProvider {
  MockExpenseProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i8.ExpenseModel> get expenses => (super.noSuchMethod(
        Invocation.getter(#expenses),
        returnValue: <_i8.ExpenseModel>[],
      ) as List<_i8.ExpenseModel>);
  ...
  @override
  _i6.Future<void> fetchExpenses(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #fetchExpenses,
          [userId],
        ),
  ...
  @override
  _i6.Future<void> addExpense(_i8.ExpenseModel? expense) => (super.noSuchMethod(
        Invocation.method(
          #addExpense,
          [expense],
        ),
  ...
  @override
  _i6.Future<void> deleteExpense(String? expenseId) => (super.noSuchMethod(
        Invocation.method(
          #deleteExpense,
          [expenseId],
        ),
  ...
  @override
  _i6.Future<void> updateExpense(_i8.ExpenseModel? updatedExpense) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateExpense,
          [updatedExpense],
  ...
  @override
  List<_i9.FlSpot> getWeeklyTrendData() => (super.noSuchMethod(
        Invocation.method(
          #getWeeklyTrendData,
          [],
        ),
  ...
  @override
  List<_i9.FlSpot> getMonthlyTrendData() => (super.noSuchMethod(
        Invocation.method(
          #getMonthlyTrendData,
          [],
        ),
  ...
  @override
  double getTotalForMonth(DateTime? month) => (super.noSuchMethod(
        Invocation.method(
          #getTotalForMonth,
          [month],
        ),
  ...
  @override
  List<_i8.ExpenseModel> getExpensesForCategoryAndMonth(
    String? category,
    DateTime? month,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #getExpensesForCategoryAndMonth,
          [
            category,
            month,
          ],
  ...
  @override
  Map<String, double> getCategorySpikes(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCurrencyProvider extends _i1.Mock implements _i11.CurrencyProvider {
  ...
  @override
  _i6.Future<void> loadCurrency() => (super.noSuchMethod(
        Invocation.method(
          #loadCurrency,
          [],
        ),
  ...
  @override
  _i6.Future<void> changeCurrency(String? newCurrency) => (super.noSuchMethod(
        Invocation.method(
          #changeCurrency,
          [newCurrency],
        ),
...
/// A class which mocks [GetawayProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetawayProvider extends _i1.Mock implements _i12.GetawayProvider {
  MockGetawayProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i13.Getaway> get getaways => (super.noSuchMethod(
        Invocation.getter(#getaways),
        returnValue: <_i13.Getaway>[],
      ) as List<_i13.Getaway>);
  ...
  @override
  _i6.Future<bool> fetchGetaways() => (super.noSuchMethod(
        Invocation.method(
          #fetchGetaways,
          [],
        ),
  ...
  @override
  _i6.Future<void> addGetaway(_i13.Getaway? getaway) => (super.noSuchMethod(
        Invocation.method(
          #addGetaway,
          [getaway],
        ),
  ...
  @override
  _i6.Future<void> deleteGetaway(String? getawayId) => (super.noSuchMethod(
        Invocation.method(
          #deleteGetaway,
          [getawayId],
        ),
  ...
  @override
  _i13.Getaway? getGetawayById(String? id) =>
...
/// A class which mocks [GetawayExpenseProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetawayExpenseProvider extends _i1.Mock
    implements _i14.GetawayExpenseProvider {
  MockGetawayExpenseProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i15.GetawayExpenseModel> get expenses => (super.noSuchMethod(
        Invocation.getter(#expenses),
        returnValue: <_i15.GetawayExpenseModel>[],
      ) as List<_i15.GetawayExpenseModel>);
  ...
  @override
  _i6.Future<void> addExpense(_i15.GetawayExpenseModel? expense) =>
      (super.noSuchMethod(
        Invocation.method(
          #addExpense,
          [expense],
  ...
  @override
  void clearExpense() => super.noSuchMethod(
        Invocation.method(
          #clearExpense,
          [],
        ),
